...
# База данных
DATABASE = 'd:/Dev/api_yamdb/api_yamdb/db.sqlite3'

# Файлы с данными
USERS = 'd:/Dev/api_yamdb/api_yamdb/static/data/users.csv'
CATEGORY = 'd:/Dev/api_yamdb/api_yamdb/static/data/category.csv'
TITLES = 'd:/Dev/api_yamdb/api_yamdb/static/data/titles.csv'
REVIEWS = 'd:/Dev/api_yamdb/api_yamdb/static/data/review.csv'
COMMENTS = 'd:/Dev/api_yamdb/api_yamdb/static/data/comments.csv'
GENRE = 'd:/Dev/api_yamdb/api_yamdb/static/data/genre.csv'
GENRE_TITLE = 'd:/Dev/api_yamdb/api_yamdb/static/data/genre_title.csv'
